...
**Selfie**:
A fictional in-character photo the carrier persona sends into the chat, generated by editing a reference image of the persona with a scene prompt. Canonically framed as a first-person phone shot — front-camera at arm's length, or a mirror selfie — so it reads as a selfie the persona took, not a portrait someone took of her; the POV is part of the term's meaning, not just rendering. Non-nude by hard rule; suggestive-but-clothed allowed. Sent proactively (rare) or on request (bounded). Not a learning artifact — pure relationship texture.
_Avoid_: image, photo (ambiguous with learner-facing content), avatar, portrait (third-person framing is exactly what a selfie is not)
